    ...
    <div id="content">
         ...
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div>
                    	<h3 class="text-info">COACH_ DETAILS</h3>
                    </div>
                   <div>
                    	<p>Welcome 
...
<nav class="d-flex justify-content-between">
    ...
    <form class="d-flex"  action="/admincoachSearch"  method="post" autocomplete="off">
        ...
        <div class="modal-dialog" role="document">
            ...
            <form action="/addcoachForm" modelAttribute="coachForm"  method="POST" enctype= "multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
						 <label for="message-text" class="col-form-label">coach </label>
                        <select id="coach_desc" name="coach_desc"  class="form-control" required>
							<option value="">Choose the Coach</option>
							<option value="Trainner">Trainner</option>
							<option value="Trainner for state level tournaments">Trainner for state level tournaments</option>
							<option value="Trainner for National level tournaments">Trainner for National level tournaments</option>
							<option value="Trainner for International Tournaments">Trainner for International Tournaments</option>
						</select>
                    </div>
                    <div class="form-group">
                	 ...
                	 <c:forEach var="allcoach" items="${coachlist}" >
			           ...
			           <td ><img src="data:image/jpeg;base64,${allcoach.coach_img}" class="rounded-circle" width="100" height="100"/></td>
                        ...
                        <td class="d-flex">
                            ...
                            <a href="/admindeletecoach/${allcoach.id}" class="btn btn-danger ml-2" onclick='return deleteCoach()'>DELETE</a>
                        </td>
                        </tr>
                    </c:forEach>
                </tbody>
