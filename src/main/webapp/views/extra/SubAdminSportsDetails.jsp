...
<nav class="d-flex justify-content-between">
      <form class="d-flex"  action="/subadminsportsSearch"  method="post" autocomplete="off">
            ...
            <form action="/addsportsForm" modelAttribute="sportsForm"  method="POST" enctype= "multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
						...
						<textarea class="form-control" name="sportsDesc" placeholder="Sports Description" id="sports_desc"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">sports Image:</label>
                        <input type="file" class="form-control" name="sportsImg1" id="sports_img" required>
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">sports Price:</label>
						<input  class="form-control"  type="text" name="price"  placeholder="Sports Price" id="sports_price" required>
                    </div>
                   
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">sports Location:</label>
						<textarea class="form-control" name="location" placeholder="Sports Location" id="sports_location"></textarea>
                    </div>
                </div>
