...
<nav class="d-flex justify-content-between">
     ...
     <form class="d-flex"  action="/superadminfacilitySearch"  method="post" autocomplete="off">
			<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
			<input type="hidden" name="user" value="superadmin" />
			<input class="form-control" type="search" name="valueToSearch" placeholder="Value To Search" aria-label="Search" value="${facility_keyword}">
