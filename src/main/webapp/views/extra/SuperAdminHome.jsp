          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div class="media-body text-right">
                  <h3 class="danger">${superadmin_sports_count}</h3>
                  <span>Total Sportss</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div class="media-body text-right">
                  <h3 class="warning">${superadmin_facility_count}</h3>
            ...
            <div class="card-body">
              <div class="media d-flex">
                <div class="media-body text-left">
                  <h3 class="danger">${superadmin_coach_count}</h3>
