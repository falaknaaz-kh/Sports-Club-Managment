	    ...
	    <!-- Page Content  -->
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div>
                    	<h3 class="text-info">COACH DETAILS</h3>
                    </div>
                   <div>
                    	<p>Welcome 
