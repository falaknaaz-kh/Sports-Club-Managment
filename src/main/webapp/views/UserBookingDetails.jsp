                                        ...
                                        <div class="widget-49">
                                            <div class="widget-49-title-wrapper">  
                                                ...
                                                <div class="widget-49-meeting-info">
                                                    <span class="font-weight-bold text-uppercase">${booking.sports.sportsName}</span> 
                                            ...
                                            <ul class="widget-49-meeting-points">
                                                <li class="widget-49-meeting-item"><span class="font-weight-bold ">Facility Name : ${booking.facility.facilityname}</span></li>
                                                ...
                                                <li class="widget-49-meeting-item"><span class="font-weight-bold ">No Of Participants : ${booking.no_of_guest}</span></li>
