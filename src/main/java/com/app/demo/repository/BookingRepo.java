...
public interface BookingRepo extends JpaRepository<Booking,Integer>{
	...
	@Query("Select b from bookings b where sports_id=?1 and accept_status=1")
	public List<Booking> findSportsById(int id);

	@Query("Select b from bookings b where facility_id=?1 and accept_status=1")
	public List<Booking> findFacilityById(int id);
