...
public class UserExcelExporter {
    ...
    private void writeHeaderLine() {
        ...
        createCell(row, 7, "SportsName", style);
        createCell(row, 8, "FacilityName", style);
        ...
        createCell(row, 18, "Sports Price", style);
        createCell(row, 19, "Facility Price", style);
    ...
    private void writeDataLines() {
        ...
        for (Booking book : bookings) {
            ...
            createCell(row, columnCount++, book.getSports().getSportsName(), style);
            createCell(row, columnCount++, book.getFacility().getFacilityname(), style);
            ...
            createCell(row, columnCount++, "Rs."+book.getSports().getPrice(), style);
            createCell(row, columnCount++, "Rs."+book.getFacility().getFacility_price(), style);
