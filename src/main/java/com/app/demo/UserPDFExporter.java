...
public class UserPDFExporter {
	...
	public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        document.add(new Paragraph("Sports Name : "+booking.getSports().getSportsName(), parafont));
       
        document.add(new Paragraph(" ", parafont));
        
        document.add(new Paragraph("Sports Location : "+booking.getSports().getLocation(), parafont));
        
        document.add(new Paragraph(" ", parafont));
        
        document.add(new Paragraph("Facility Name : "+booking.getFacility().getFacilityname(), parafont));
       
        document.add(new Paragraph(" ", parafont));
                
        document.add(new Paragraph("Facility Location : "+booking.getFacility().getFacility_location(), parafont));
        ...
        document.add(new Paragraph("Sports  Price : Rs."+booking.getSports().getPrice()+" per hour", parafont));
        ...
        document.add(new Paragraph("Facility Price : Rs."+booking.getFacility().getFacility_price()+" per person", parafont));
