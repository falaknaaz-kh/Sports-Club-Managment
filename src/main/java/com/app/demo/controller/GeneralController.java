...
//		User user=userservice.findById(id);
		...
		long Sportscount=sportsservice.sportsCount();
		model.addAttribute("user_sports_count",Sportscount);
		
		long Eventcount=eventservice.eventCount();
		model.addAttribute("user_event_count",Eventcount);
		
		long Facilitycount=facilityservice.facilitycount();
		model.addAttribute("user_facility_count",Facilitycount);
		
		long Coachcount=coachservice.coachcount();
		model.addAttribute("user_coach_count",Coachcount);
	...
	public String adminhome(ModelMap model) {
		...
		long Sportscount=sportsservice.sportsCount();
		model.addAttribute("admin_sports_count",Sportscount);
		
		long Eventcount=eventservice.eventCount();
		model.addAttribute("admin_event_count",Eventcount);
		
		long Facilitycount=facilityservice.facilitycount();
		model.addAttribute("admin_facility_count",Facilitycount);
		
		long Coachcount=coachservice.coachcount();
		model.addAttribute("admin_coach_count",Coachcount);
	...
	public String subAdminHome(ModelMap model) {
		...
		long Sportscount=sportsservice.sportsCount();
		model.addAttribute("subadmin_sports_count",Sportscount);
		
		long Eventcount=eventservice.eventCount();
		model.addAttribute("subadmin_event_count",Eventcount);
		
		long Facilitycount=facilityservice.facilitycount();
		model.addAttribute("subadmin_facility_count",Facilitycount);
		
		long Coachcount=coachservice.coachcount();
		model.addAttribute("subadmin_coach_count",Coachcount);
	...
	public String superAdminHome(ModelMap model) {
		...
		long Sportscount=sportsservice.sportsCount();
		model.addAttribute("superadmin_sports_count",Sportscount);
		
		long Eventcount=eventservice.eventCount();
		model.addAttribute("superadmin_event_count",Eventcount);
		
		long Facilitycount=facilityservice.facilitycount();
		model.addAttribute("superadmin_facility_count",Facilitycount);
		
		long Coachcount=coachservice.coachcount();
		model.addAttribute("superadmin_coach_count",Coachcount);
