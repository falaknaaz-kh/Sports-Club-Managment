...
public class BookingServices {
	...
	public List<Booking> findBySportsId(int id) {
		// TODO Auto-generated method stub
		return bookingrepo.findSportsById(id);
	}

	public List<Booking> findByFacilityId(int id) {
		// TODO Auto-generated method stub
		return bookingrepo.findFacilityById(id);
	}
